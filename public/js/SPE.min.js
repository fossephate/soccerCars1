...
SPE.Group.prototype._triggerSingleEmitter = function( pos, vel ) {
    'use strict';
...
SPE.Group.prototype.triggerPoolEmitter = function( numEmitters, position, velocity ) {
    'use strict';

    if ( typeof numEmitters === 'number' && numEmitters > 1 ) {
        for ( var i = 0; i < numEmitters; ++i ) {
            this._triggerSingleEmitter( position, velocity );
        }
    }
    else {
        this._triggerSingleEmitter( position, velocity );
